...
自动扫描你安装的所有 WorkBuddy 技能和 SOP 工作流文件，生成一份完整的 **HTML 速查手册**。
...
手册是一个单文件 HTML（无需联网），包含：

**SOP 手册 Tab：**
- 按工作区分类展示所有 SOP
- 点击卡片展开，查看完整流程步骤
- 点击步骤名，展开查看「做什么 + 规则 + 工具 + 文件路径」
- 点击「📋 SOP原文」按钮，直接打开本地原始文件

**技能手册 Tab：**
- 按分类展示所有已安装技能
- 支持搜索（按名称/描述/触发词）
- 支持按类型筛选（用户级 / 内置插件 / 系统内置）
- 点击「🛠 技能原文」按钮，直接打开本地 SKILL.md
